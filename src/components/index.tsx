...
// We create the card's container, header and content...
  ...
  return (
    <div className="flex flex-row items-center justify-between p-3 border-b border-slate-200">
      ...
      <button
        type="button"
        onClick={clearAllFn}
        className="text-sm font-medium text-gray-600 underlin"
      >
        Clear All
      </button>
    </div>
...
// Form for adding new elements to the list
